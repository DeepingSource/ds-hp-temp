...
export const homeCopy: Record<Locale, {
  ...
  en: {
    ...
    heroSub: 'On the CCTV you already have — not who, but what and how. Anonymized Spatial AI that observes, analyzes, suggests, and learns from your space.',
  ...
  jp: {
    ...
    heroSub: 'すでにあるCCTVの上で — 誰かではなく、何をどう。空間を観察し、分析し、提案し、学習する匿名化された空間AIです。',
    ctaPrimary: '導入のご相談',
    ctaSecondary: '製品を見る',
  },
};
