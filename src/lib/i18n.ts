...
export const homeCopy: Record<Locale, {
  ...
  en: {
    ...
    heroSub: 'On the CCTV you already have — not who, but what and how. Anonymized Spatial AI that reads, flags, and acts on your space.',
  ...
  ko: {
    ...
    heroSub: '이미 달린 CCTV 위에서 — 누가가 아니라 무엇을 어떻게. 공간을 읽고, 알리고, 실행하는 익명화 공간 AI입니다.',
    ctaPrimary: '도입 상담',
    ctaSecondary: '제품 보기',
  },
  jp: {
    ...
    heroSub: 'すでにあるCCTVの上で — 誰かではなく、何をどう。空間を読み、知らせ、動かす匿名化された空間AIです。',
    ctaPrimary: '導入のご相談',
    ctaSecondary: '製品を見る',
  },
};
