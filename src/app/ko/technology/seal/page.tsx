...
export const metadata: Metadata = {
  ...
  description:
    '영상 속 얼굴과 번호판을 지우면서 AI에 필요한 특징은 그대로 남기는 영상 익명화 솔루션 SEAL. 익명화 전후 비교, 비전 태스크 입증, 블러·마스크와의 차이, 내장 SDK까지.',
  alternates: {
  ...
  openGraph: {
    ...
    images: [{ url: '/images/og/seal.png', width: 2500, height: 1313, alt: 'SEAL — 데이터는 살리는 영상 익명화' }],
  },
};
