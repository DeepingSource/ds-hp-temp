...
export const metadata: Metadata = {
  title: 'Anonymizer — 영상 비식별화 모듈 | DeepingSource',
  description:
    'CCTV·영상 스트림에서 개인 식별 정보를 실시간으로 제거하면서 분석에 필요한 행동·동선 신호는 보존하는 비식별화 모듈. 처리 메커니즘, 사양, 규제 준수를 정리합니다.',
  alternates: {
  ...
  openGraph: {
    title: 'Anonymizer — 영상 비식별화 모듈 | DeepingSource',
    description: '개인 식별 정보는 제거하고 분석 신호는 보존하는 영상 비식별화 모듈의 기술 개요.',
