...
export const metadata: Metadata = {
  ...
  description:
    'store insight·store agent·store care·SAAI. 엔터프라이즈 공간 분석부터 사장님용 안심 솔루션, B2C 콘텐츠까지. 모든 매장을 한 매장처럼 운영하는 DeepingSource의 제품 라인업.',
  ...
  openGraph: {
    ...
    description: '모든 매장을 한 매장처럼. 엔터프라이즈 분석부터 사장님용 안심, B2C 콘텐츠까지.',
    type: 'website',
  },
};
