...
export const metadata: Metadata = {
  ...
  description:
    '익명화 공간 AI — saai insight·saai agent·saai care·SAAI. 엔터프라이즈 공간 분석부터 사장님용 안심 솔루션, B2C 콘텐츠까지. 모든 공간을 완벽하게 운영하는 DeepingSource의 제품 라인업.',
  keywords: ['DeepingSource', '제품', 'saai insight', 'saai agent', 'saai care', 'SAAI', '매장 분석', '공간 인텔리전스', '익명화 공간 AI'],
  alternates: {
