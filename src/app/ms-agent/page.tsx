...
export const metadata: Metadata = {
  title: 'StoreAgent — 편의점 AI 운영 비서 | 발주·진열·프로모션 자동 제안',
  ...
  openGraph: {
    title: 'StoreAgent — 편의점 AI 운영 비서',
    description: '매일 아침 편의점 맞춤 브리핑을 받아보세요. 발주, 진열, 프로모션까지 AI가 정리합니다.',
    url: 'https://agent.saai.store',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'StoreAgent — 편의점 AI 운영 비서' }],
  },
  twitter: {
