...
export const metadata: Metadata = {
  title: 'Anonymizer — 映像非識別化モジュール | DeepingSource',
  description:
    'CCTV・映像ストリームから個人識別情報をリアルタイムで除去しながら、分析に必要な行動・動線の信号は保持する非識別化モジュール。処理メカニズム、仕様、規制準拠を整理します。',
  alternates: {
  ...
  openGraph: {
    title: 'Anonymizer — 映像非識別化モジュール | DeepingSource',
    description: '個人識別情報は除去し、分析信号は保持する映像非識別化モジュールの技術概要。',
