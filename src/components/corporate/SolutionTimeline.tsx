...
const dict: Record<Locale, { eyebrow: string; heading: string; sub: string; nodes: Node[] }> = {
  ko: {
    ...
    nodes: [
      { key: 'insight', icon: History, product: 'store insight', desc: '어제를 읽습니다 — 매출이 미처 보지 못한 것을.', img: '/images/storeinsight-heatmap.webp', alt: '매장 히트맵 — 고객 체류·동선 분석', href: '/products/saai-insight' },
      ...
      { key: 'agent', icon: Sparkles, product: 'store agent', desc: '다음을 제안하고 운영합니다 — 권고는 AI가, 결정은 사람이.', img: '/images/storeagent-ai-pop-mockup.webp', alt: 'store agent — 다음 한 수 제안 화면', href: '/products/saai-agent' },
    ],
  },
  en: {
    ...
    nodes: [
      { key: 'insight', icon: History, product: 'store insight', desc: 'Reads yesterday — what your sales numbers never showed you.', img: '/images/storeinsight-heatmap.webp', alt: 'Store heatmap — dwell and pathway analysis', href: '/products/saai-insight' },
      ...
      { key: 'agent', icon: Sparkles, product: 'store agent', desc: 'Proposes and runs the next move — AI recommends, you decide.', img: '/images/storeagent-ai-pop-mockup.webp', alt: 'store agent — next-move proposal screen', href: '/products/saai-agent' },
    ],
  },
  jp: {
    eyebrow: '昨日 · 今 · 次',
    ...
    nodes: [
      { key: 'insight', icon: History, product: 'store insight', desc: '昨日を読みます — 売上が見落としていたものまで。', img: '/images/storeinsight-heatmap.webp', alt: '店舗ヒートマップ — 滞在・動線分析', href: '/products/saai-insight' },
      ...
      { key: 'agent', icon: Sparkles, product: 'store agent', desc: '次を提案し、運営します — 推奨はAI、判断は人。', img: '/images/storeagent-ai-pop-mockup.webp', alt: 'store agent — 次の一手の提案画面', href: '/products/saai-agent' },
    ],
  },
};
