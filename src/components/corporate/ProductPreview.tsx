...
const copy: Record<Locale, { eyebrow: string; heading: string; sub: string; isoAlt: string; note: string; features: Feature[] }> = {
  ko: {
    ...
    features: [
      ...
      { icon: BellRing, title: '필요한 순간만, 다음 한 수까지', desc: '필요한 순간만 골라 알리고, 다음 한 수까지 제안합니다.' },
    ],
  },
  en: {
    eyebrow: 'Products at a glance',
    ...
    features: [
      ...
      { icon: BellRing, title: 'Only the moments that matter — to the next move', desc: 'Surface only the moments that matter, then recommend the next move.' },
    ],
  },
  jp: {
    eyebrow: 'Products at a glance',
    ...
    features: [
      ...
      { icon: BellRing, title: '必要な瞬間だけ、次の一手まで', desc: '必要な瞬間だけを選んで通知し、次の一手まで提案。' },
    ],
  },
};
