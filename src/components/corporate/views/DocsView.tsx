...
const C: Record<Locale, {
  ...
  ko: {
    ...
    navSections: [
      ...
      { id: 'integration', title: '연동 가이드', items: [{ title: 'CCTV 연동', slug: 'cctv-integration' }, { title: 'POS 연동', slug: 'pos-integration' }, { title: '대시보드 접근' }, { title: 'API 개요' }] },
  ...
  en: {
    ...
    navSections: [
      ...
      { id: 'integration', title: 'Integration Guide', items: [{ title: 'CCTV Integration', slug: 'cctv-integration' }, { title: 'POS Integration', slug: 'pos-integration' }, { title: 'Dashboard Access' }, { title: 'API Overview' }] },
  ...
  jp: {
    ...
    navSections: [
      ...
      { id: 'integration', title: '連携ガイド', items: [{ title: 'CCTV 連携', slug: 'cctv-integration' }, { title: 'POS 連携', slug: 'pos-integration' }, { title: 'ダッシュボードへのアクセス' }, { title: 'API 概要' }] },
