...
const C: Record<Locale, {
  ...
  ko: {
    ...
    navSections: [
      ...
      { id: 'privacy', title: '프라이버시 & 보안', items: [{ title: '익명화 동작 원리', slug: 'how-anonymization-works' }, { title: '데이터 보관 정책', slug: 'data-retention-policy' }, { title: '접근 권한 관리', slug: 'access-control' }, { title: '컴플라이언스' }] },
  ...
  en: {
    ...
    navSections: [
      ...
      { id: 'privacy', title: 'Privacy & Security', items: [{ title: 'How Anonymization Works', slug: 'how-anonymization-works' }, { title: 'Data Retention Policy', slug: 'data-retention-policy' }, { title: 'Access Control', slug: 'access-control' }, { title: 'Compliance' }] },
  ...
  jp: {
    ...
    navSections: [
      ...
      { id: 'privacy', title: 'プライバシー & セキュリティ', items: [{ title: '匿名化の仕組み', slug: 'how-anonymization-works' }, { title: 'データ保管ポリシー', slug: 'data-retention-policy' }, { title: 'アクセス権限の管理', slug: 'access-control' }, { title: 'コンプライアンス' }] },
