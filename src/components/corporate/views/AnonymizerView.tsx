...
const ko: Copy = {
  ...
  specRows: [
    ...
    { feature: '지우는 대상', detail: '얼굴·체형·번호판 등 신원 정보', note: '신원은 남기지 않음' },
  ...
  faqItems: [
    ...
    { question: '익명화된 영상에서 원본이나 신원을 복원할 수 있나요?', answer: '재식별은 불가능하도록 설계됩니다. 신원 영역은 분석 신호를 보존하면서도 되돌릴 수 없게 지웁니다. 익명화된 데이터로부터 누구였는지를 되찾을 수 없는 것이 원칙이며, 처리 강도는 적용 환경에 맞게 조정합니다.' },
