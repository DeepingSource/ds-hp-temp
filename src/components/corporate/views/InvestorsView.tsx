...
const C: Record<Locale, Copy> = {
  ko: {
    ...
    tractionFootnote: `${COMPANY.nvidiaPartner} · 설립 ${COMPANY.foundingYear}년 · 특허·파트너·업종 수는 자사 집계 기준 (2026)`,
    milestonesEyebrow: 'Milestones',
    milestonesHeading: '한 점주의 질문에서 표준까지',
    mailSubject: 'IR 문의',
    ctaHeading: 'IR 문의',
    ctaSub: 'IR Deck·브랜드 자료는 개별 요청에 한해 제공합니다. 투자·IR 문의는 아래로 연락 주세요. 영업일 기준 2~3일 내 회신드립니다.',
    ctaForm: '문의 양식',
  },
  en: {
    badge: 'Investor Relations',
    ...
    tractionFootnote: `${COMPANY.nvidiaPartner} · Founded ${COMPANY.foundingYear} · Patent, partner, and industry counts are company figures (as of 2026)`,
    milestonesEyebrow: 'Milestones',
    milestonesHeading: 'From one store owner’s question to the standard',
    mailSubject: 'IR inquiry',
    ctaHeading: 'IR inquiries',
    ctaSub: 'The IR Deck and brand materials are provided on an individual-request basis. For investment and IR inquiries, reach us below. We typically respond within 2–3 business days.',
  ...
  jp: {
    ...
    tractionFootnote: `${COMPANY.nvidiaPartner} · 設立${COMPANY.foundingYear}年 · 特許・パートナー・業種数は自社集計基準 (2026)`,
    milestonesEyebrow: 'Milestones',
    milestonesHeading: '一軒の店主の問いから標準まで',
    mailSubject: 'IRのお問い合わせ',
    ctaHeading: 'IRのお問い合わせ',
    ctaSub: 'IR Deck · ブランド資料は個別のご要望に応じて提供します。投資 · IRのお問い合わせは下記までご連絡ください。営業日2〜3日以内にご返信します。',
    ctaForm: 'お問い合わせフォーム',
  },
};
