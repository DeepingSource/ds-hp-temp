...
const COPY: Record<Locale, {
  ...
  ko: {
    ...
    heroSub: '누가 근무하든 같은 기준으로 — 도난·위생·설비 이상을 전 매장에서 실시간 감지해 본사 한 화면으로 모옵니다. 기존 CCTV 그대로, 원본 영상은 남기지 않고.',
    heroCta: '본사 도입 상담하기',
  ...
  jp: {
    ...
    faqs: [
      ...
      { q: '加盟店から「監視」だと反発されませんか？', a: 'SEAL技術がエッジ段階で動画を即座に破棄するため、本部は匿名イベントのみを受신します。' },
