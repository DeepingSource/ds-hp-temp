...
const C: Record<Locale, {
  ...
  ko: {
    ...
    scenariosSub: '직원이 못 본 사이에도 — saai care는 매대·위생·설비·보안을 한눈에 살핍니다.',
  ...
  en: {
    ...
    scenariosSub: 'Even when no one’s looking — saai care watches shelves, hygiene, equipment, and security at once.',
  ...
  jp: {
    ...
    scenariosSub: 'スタッフが見ていない間も — saai care は棚・衛生・設備・防犯をひと目で見守ります。',
