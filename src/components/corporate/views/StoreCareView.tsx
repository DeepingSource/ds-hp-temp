...
const C: Record<Locale, {
  ...
  ko: {
    ...
    valueNote: ['Store Care는 Deeping Source의 점주용 서비스로, 별도 사이트 storecare.ai에서 운영됩니다.', ''],
  ...
  en: {
    ...
    valueNote: ['Store Care is Deeping Source’s service for store owners, operated on the separate site storecare.ai.', ''],
  ...
  jp: {
    ...
    valueNote: ['Store Care は Deeping Source の店主向けサービスで、別サイトの storecare.ai で運営しています。', ''],
