...
const ko: Copy = {
  ...
  spineSteps: [
    ...
    { title: '찾습니다', desc: '잘되는 매장의 패턴을, 당신 체인 데이터 안에서 찾습니다.' },
...
const en: Copy = {
  ...
  heroTitleA: 'Read your chain —',
  heroTitleB: 'get a proposal built for it.',
  ...
  ctaEmail: 'Email us',
  emailSubject: '[Chains & HQ] Tailored proposal inquiry',
  ...
  spineSteps: [
    ...
    { title: 'We find', desc: 'The pattern behind the best stores, inside your own chain’s data.' },
  ...
  ctaTitleB: 'and tune it to your chain.',
...
const jp: Copy = {
  ...
  spineSteps: [
    ...
    { title: '見つける', desc: 'うまくいく店舗のパターンを、御社チェーンのデータの中から見つけます。' },
