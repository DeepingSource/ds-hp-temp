...
const C: Record<Locale, Copy> = {
  ko: {
    ...
    planEyebrow: '비즈니스 모델',
    planHeading: '무료로 유입·습관, Pro로 수익화, 고급으로 천장 돌파',
    planSub: '도입 장벽이 낮은 카메라리스 SW가 기본입니다. 무료로 습관을 만들고, 운영 의사결정을 완주하는 Pro로 수익화합니다.',
    plans: [
      { tier: 'Free', price: '₩0', desc: '유입 · 습관 · 데이터', items: ['템플릿 POP 무제한 · 월 무료 크레딧', '일상 챗 · 데일리 코치', '스토어레터 무료 구독'] },
      { tier: 'Pro', price: '₩9,900~', desc: '운영 의사결정 완주', items: ['AI 포스터 · 진열 점검 · 레터 풀', 'POS 상시 분석 · 챗 한도 상향', '5단계 루프 전체'], highlight: true },
      { tier: '고급 · 자매 제품', price: '₩14,900~', desc: 'WTP 천장 돌파', items: ['store care — CCTV 도난·이상 감지·온도 알림', 'store insight — 대시보드·정기 리포트', '교차 판매로 ARPU 확장'] },
    ],
    planNote: '* 가격 모델은 클로즈드 베타로 검증 중인 가설입니다. 실제 요금·구성은 달라질 수 있습니다.',
  ...
  en: {
    ...
    planEyebrow: 'Business model',
    planHeading: 'Free to acquire and habituate, Pro to monetize, premium to break the ceiling',
    planSub: 'A low-barrier camera-less app is the base. Free builds the habit; Pro monetizes the owners who run the full operating decision.',
    plans: [
      { tier: 'Free', price: '₩0', desc: 'Acquire · habit · data', items: ['Unlimited template POP · free monthly credits', 'Daily chat · daily coach', 'Free store-letter subscription'] },
      { tier: 'Pro', price: '₩9,900+', desc: 'Run the full decision', items: ['AI posters · planogram check · letter pool', 'Always-on POS analysis · higher chat limits', 'The full 5-step loop'], highlight: true },
      { tier: 'Premium · sister products', price: '₩14,900+', desc: 'Break the WTP ceiling', items: ['store care — CCTV theft/anomaly & temperature alerts', 'store insight — dashboards & regular reports', 'ARPU expansion via cross-sell'] },
    ],
    planNote: '* Pricing is a hypothesis under closed-beta validation. Actual prices and tiers may change.',
  ...
  jp: {
    ...
    planEyebrow: 'ビジネスモデル',
    planHeading: '無料で流入・習慣、Proで収益化、上位で天井突破',
    planSub: '導入障壁の低いカメラレスSWが基本です。無料で習慣をつくり、運営の意思決定を完走するProで収益化します。',
    plans: [
      { tier: 'Free', price: '₩0', desc: '流入 · 習慣 · データ', items: ['テンプレPOP無制限 · 月の無料クレジット', '日常チャット · デイリーコーチ', 'ストアレター無料購読'] },
      { tier: 'Pro', price: '₩9,900〜', desc: '運営の意思決定を完走', items: ['AIポスター · 陳列点検 · レタープール', 'POS常時分析 · チャット上限引き上げ', '5段階ループ全体'], highlight: true },
      { tier: '上位 · 姉妹製品', price: '₩14,900〜', desc: 'WTPの天井を突破', items: ['store care — CCTV盗難・異常検知・温度アラート', 'store insight — ダッシュボード・定期レポート', 'クロスセルでARPU拡張'] },
    ],
    planNote: '* 価格モデルはクローズドベータで検証中の仮説です。実際の料金・構成は変わり得ます。',
