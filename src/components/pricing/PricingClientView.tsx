...
const CODE: Record<Locale, PricingCode> = {
  ko: {
    diffFooterPre: 'saai agent 기본형은 ',
    diffFooterInfo: '정보 제공',
    diffFooterMid: ' 서비스 · saai care는 ',
  ...
  en: {
    diffFooterPre: 'saai agent basic is an ',
    diffFooterInfo: 'information',
    diffFooterMid: ' service · saai care is a ',
  ...
  jp: {
    diffFooterPre: 'saai agent 基本型は',
    diffFooterInfo: '情報提供',
    diffFooterMid: 'サービス・saai care は',
