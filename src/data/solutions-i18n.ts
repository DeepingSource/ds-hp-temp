...
> = {
  ...
  'convenience-night-theft': {
    en: {
      ...
      steps: [
        { title: 'Real-time capture of overnight abnormal behavior', productLabel: '01 Observe · store care' },
        { title: 'Theft-risk pattern analysis by time of day', productLabel: '02 Analyze · store insight' },
        { title: 'Automatic alerts and response on anomalies', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: '夜間の異常行動をリアルタイムに捕捉', productLabel: '01 観察 · store care' },
        { title: '時間帯別の盗難リスクパターン分析', productLabel: '02 分析 · store insight' },
        { title: '異常発生時の自動通知と対応', productLabel: '03 実行 · store agent' },
      ],
  ...
  'convenience-inventory-loss': {
    en: {
      ...
      steps: [
        { title: 'Automatic stockout checks on key shelves', productLabel: '01 Observe · store care' },
        { title: 'Stockout frequency and loss pattern analysis', productLabel: '02 Analyze · store insight' },
        { title: 'Automatic restocking notifications', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: '主要棚の欠品を自動確認', productLabel: '01 観察 · store care' },
        { title: '欠品頻度と損失パターンの分析', productLabel: '02 分析 · store insight' },
        { title: '補充案内の自動送信', productLabel: '03 実行 · store agent' },
      ],
  ...
  'convenience-planogram': {
    en: {
      ...
      steps: [
        { title: 'Recognize customer contact patterns by zone', productLabel: '01 Observe · store care' },
        { title: 'Conversion and attention analysis by shelf', productLabel: '02 Analyze · store insight' },
        { title: 'Automatic display-optimization suggestions', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: 'エリア別の顧客接触パターンを認識', productLabel: '01 観察 · store care' },
        { title: '棚別の転換率・注目度分析', productLabel: '02 分析 · store insight' },
        { title: '陳列最適化の提案を自動送信', productLabel: '03 実行 · store agent' },
      ],
  ...
  'cafe-low-seat-turnover': {
    en: {
      ...
      steps: [
        { title: 'Real-time seating detection per table', productLabel: '01 Observe · store care' },
        { title: 'Seat-turnover and dwell-time analysis', productLabel: '02 Analyze · store insight' },
        { title: 'Peak-hour operations guidance', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: 'テーブル別の着席をリアルタイム認識', productLabel: '01 観察 · store care' },
        { title: '座席回転率・滞在時間の分析', productLabel: '02 分析 · store insight' },
        { title: 'ピークタイムの運営最適化案内', productLabel: '03 実行 · store agent' },
      ],
  ...
  'cafe-peak-hour-management': {
    en: {
      ...
      steps: [
        { title: 'Automatic visitor count by time of day', productLabel: '01 Observe · store care' },
        { title: 'Visit-pattern analysis and peak prediction', productLabel: '02 Analyze · store insight' },
        { title: 'Peak forecast and preparation guidance', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: '時間帯別の来店客数を自動集計', productLabel: '01 観察 · store care' },
        { title: '来店パターン分析とピーク予測', productLabel: '02 分析 · store insight' },
        { title: 'ピーク予測の案内と準備ガイド', productLabel: '03 実行 · store agent' },
      ],
  ...
  'cafe-customer-wait-time': {
    en: {
      ...
      steps: [
        { title: 'Real-time queue length and walk-away tracking', productLabel: '01 Observe · store care' },
        { title: 'Wait-pattern analysis and bottleneck detection', productLabel: '02 Analyze · store insight' },
        { title: 'Operations suggestions to minimize waiting', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: '待ち行列の長さと離脱客をリアルタイム把握', productLabel: '01 観察 · store care' },
        { title: '待機パターン分析とボトルネック把握', productLabel: '02 分析 · store insight' },
        { title: '待機最小化のための運営提案', productLabel: '03 実行 · store agent' },
      ],
  ...
  'unmanned-theft-prevention': {
    en: {
      ...
      steps: [
        { title: 'Anomaly detection tuned for unmanned settings', productLabel: '01 Observe · store care' },
        { title: 'Cumulative theft-risk pattern analysis', productLabel: '02 Analyze · store insight' },
        { title: 'Multi-channel alerts and remote response', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: '無人環境に特化した異常行動検知', productLabel: '01 観察 · store care' },
        { title: '盗難リスクパターンの累積分析', productLabel: '02 分析 · store insight' },
        { title: '多重通知と遠隔対応', productLabel: '03 実行 · store agent' },
      ],
  ...
  'unmanned-anomaly-detection': {
    en: {
      ...
      steps: [
        { title: 'Simultaneous detection of multiple anomaly types', productLabel: '01 Observe · store care' },
        { title: 'Anomaly event logs and statistical analysis', productLabel: '02 Analyze · store insight' },
        { title: 'Automated response per anomaly type', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: '多タイプの異常状況を同時検知', productLabel: '01 観察 · store care' },
        { title: '異常イベントログと統計分析', productLabel: '02 分析 · store insight' },
        { title: '異常タイプ別の自動対応実行', productLabel: '03 実行 · store agent' },
      ],
  ...
  'unmanned-remote-monitoring': {
    en: {
      ...
      steps: [
        { title: 'Unified real-time dashboard across sites', productLabel: '01 Observe · store care' },
        { title: 'Comparative performance analysis by site', productLabel: '02 Analyze · store insight' },
        { title: 'Selective visit alerts only on anomalies', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: '多店舗の状態を統合リアルタイム表示', productLabel: '01 観察 · store care' },
        { title: '店舗別の運営成果の比較分析', productLabel: '02 分析 · store insight' },
        { title: '異常発生時のみ選択的に訪問通知', productLabel: '03 実行 · store agent' },
      ],
  ...
  'drugstore-vmd-optimization': {
    en: {
      ...
      steps: [
        { title: 'Capture dwell time and tester contact by zone', productLabel: '01 Observe · store care' },
        { title: 'Zone performance and flow-pattern analysis', productLabel: '02 Analyze · store insight' },
        { title: 'VMD suggestions and impact measurement', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: 'エリア別の滞在時間とテスター接触を捕捉', productLabel: '01 観察 · store care' },
        { title: 'エリア成果の比較と動線パターン分析', productLabel: '02 分析 · store insight' },
        { title: 'VMD最適化提案と効果測定', productLabel: '03 実行 · store agent' },
      ],
  ...
  'drugstore-zone-performance': {
    en: {
      ...
      steps: [
        { title: 'Measure visit rate and dwell time across all zones', productLabel: '01 Observe · store care' },
        { title: 'Zone performance heatmap and path analysis', productLabel: '02 Analyze · store insight' },
        { title: 'Blind-spot improvement suggestions', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: '全エリアの来訪率と滞在時間を測定', productLabel: '01 観察 · store care' },
        { title: 'エリア別成果ヒートマップと移動経路分析', productLabel: '02 分析 · store insight' },
        { title: '死角エリアの改善提案', productLabel: '03 実行 · store agent' },
      ],
  ...
  'drugstore-tester-interaction': {
    en: {
      ...
      steps: [
        { title: 'Automatic recognition of tester contact behavior', productLabel: '01 Observe · store care' },
        { title: 'Tester contact vs. purchase conversion analysis', productLabel: '02 Analyze · store insight' },
        { title: 'Optimal tester placement suggestions', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: 'テスター接触行動を自動認識', productLabel: '01 観察 · store care' },
        { title: 'テスター接触に対する購入転換率分析', productLabel: '02 分析 · store insight' },
        { title: '最適なテスター配置の提案', productLabel: '03 実行 · store agent' },
      ],
  ...
  'mart-checkout-congestion': {
    en: {
      ...
      steps: [
        { title: 'Real-time queue monitoring per checkout', productLabel: '01 Observe · store care' },
        { title: 'Peak-hour checkout demand forecasting', productLabel: '02 Analyze · store insight' },
        { title: 'Proactive checkout operations guidance', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: 'レジ別の待ち行列をリアルタイム監視', productLabel: '01 観察 · store care' },
        { title: 'ピークタイムのレジ需要予測', productLabel: '02 分析 · store insight' },
        { title: 'レジの先制的な運営案内', productLabel: '03 実行 · store agent' },
      ],
  ...
  'mart-cart-path-optimization': {
    en: {
      ...
      steps: [
        { title: 'Continuous path linking across multiple cameras', productLabel: '01 Observe · store care' },
        { title: 'Path-pattern and zone visit-rate analysis', productLabel: '02 Analyze · store insight' },
        { title: 'Path-optimized layout suggestions', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: '多カメラで連続動線を連結', productLabel: '01 観察 · store care' },
        { title: '動線パターンとエリア来訪率の分析', productLabel: '02 分析 · store insight' },
        { title: '動線最適化レイアウトの提案', productLabel: '03 実行 · store agent' },
      ],
  ...
  'mart-zone-conversion': {
    en: {
      ...
      steps: [
        { title: 'Measure visitors and dwell behavior by zone', productLabel: '01 Observe · store care' },
        { title: 'POS-linked conversion calculation by zone', productLabel: '02 Analyze · store insight' },
        { title: 'Prioritized conversion-improvement zones', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: 'エリア別の来訪客数と滞在行動を測定', productLabel: '01 観察 · store care' },
        { title: 'POS連動のエリア別転換率算出', productLabel: '02 分析 · store insight' },
        { title: '転換率改善エリアの優先順位提案', productLabel: '03 実行 · store agent' },
      ],
  ...
  'exhibition-visitor-dwell-time': {
    en: {
      ...
      steps: [
        { title: 'Automatic dwell-time measurement per booth/exhibit', productLabel: '01 Observe · store care' },
        { title: 'Visitor-flow and attention analysis', productLabel: '02 Analyze · store insight' },
        { title: 'Automatic post-event insight report', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: 'ブース・作品別の滞在時間を自動測定', productLabel: '01 観察 · store care' },
        { title: '観覧動線と注目度の分析', productLabel: '02 分析 · store insight' },
        { title: '行事終了後のインサイトレポートを自動生成', productLabel: '03 実行 · store agent' },
      ],
  ...
  'exhibition-booth-performance': {
    en: {
      ...
      steps: [
        { title: 'Automatic visitor count per booth', productLabel: '01 Observe · store care' },
        { title: 'Booth performance and location-effect analysis', productLabel: '02 Analyze · store insight' },
        { title: 'Automatic per-exhibitor performance reports', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: 'ブース別の来場者数を自動集計', productLabel: '01 観察 · store care' },
        { title: 'ブース成果と位置効果の分析', productLabel: '02 分析 · store insight' },
        { title: '出展社別の成果レポートを自動提供', productLabel: '03 実行 · store agent' },
      ],
  ...
  'exhibition-crowd-flow': {
    en: {
      ...
      steps: [
        { title: 'Real-time congestion monitoring by zone', productLabel: '01 Observe · store care' },
        { title: 'Crowd-flow pattern analysis', productLabel: '02 Analyze · store insight' },
        { title: 'Early congestion capture and dispersal alerts', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: 'エリア別のリアルタイム混雑度モニタリング', productLabel: '01 観察 · store care' },
        { title: '人流パターンの分析', productLabel: '02 分析 · store insight' },
        { title: '混雑の早期捕捉と分散通知', productLabel: '03 実行 · store agent' },
      ],
  ...
  'logistics-worker-safety': {
    en: {
      ...
      steps: [
        { title: 'Real-time check of PPE use and hazardous-zone access', productLabel: '01 Observe · store care' },
        { title: 'Zone-by-zone safety-violation pattern analysis', productLabel: '02 Analyze · store insight' },
        { title: 'Real-time alarms and automatic logging', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: '保護具着用と危険区域接近をリアルタイム確認', productLabel: '01 観察 · store care' },
        { title: 'エリア別の安全違反パターン分析', productLabel: '02 分析 · store insight' },
        { title: 'リアルタイム警報と自動記録', productLabel: '03 実行 · store agent' },
      ],
  ...
  'logistics-efficiency-zones': {
    en: {
      ...
      steps: [
        { title: 'Measure worker distribution and movement by zone', productLabel: '01 Observe · store care' },
        { title: 'Bottleneck and efficiency-drop pattern analysis', productLabel: '02 Analyze · store insight' },
        { title: 'Real-time work-allocation optimization alerts', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: 'エリア別の作業者分布と移動パターンを測定', productLabel: '01 観察 · store care' },
        { title: '作業ボトルネックと効率低下パターンの分析', productLabel: '02 分析 · store insight' },
        { title: 'リアルタイム作業配分最適化の通知', productLabel: '03 実行 · store agent' },
      ],
  ...
  'logistics-ppe-compliance': {
    en: {
      ...
      steps: [
        { title: 'AI auto-detection of PPE use', productLabel: '01 Observe · store care' },
        { title: 'Compliance-rate analysis by zone and time', productLabel: '02 Analyze · store insight' },
        { title: 'Automatic PPE compliance reports', productLabel: '03 Act · store agent' },
      ],
    ...
    jp: {
      ...
      steps: [
        { title: '保護具着用をAIで自動検出', productLabel: '01 観察 · store care' },
        { title: 'エリア別・時間帯別の遵守率分析', productLabel: '02 分析 · store insight' },
        { title: 'PPE遵守率の自動レポート', productLabel: '03 実行 · store agent' },
      ],
